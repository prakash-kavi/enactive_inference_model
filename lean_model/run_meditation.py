...
Usage:
    python -m lean_model.run_meditation run      # Train + simulate both expert and novice
    python -m lean_model.run_meditation plot     # Generate plots from saved results
    python -m lean_model.run_meditation run --timesteps 5000  # Custom timesteps
"""
...
# Get paths relative to lean_model directory
LEAN_MODEL_DIR = Path(__file__).parent
OUTPUT_DIR = LEAN_MODEL_DIR / 'data'
PLOT_DIR = LEAN_MODEL_DIR / 'plots'
