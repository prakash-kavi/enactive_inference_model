...
Usage:
    python run_enactive_inference.py run      # Train expert + novice and generate plots
    python run_enactive_inference.py plot     # Generate plots from saved results
    python run_enactive_inference.py run --timesteps 5000  # Custom timesteps
"""
...
Examples:
  ...
  python run_enactive_inference.py run --timesteps 5000
